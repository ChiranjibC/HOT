    ...
    public class MockProduct : MockData, IProduct
    {
        ...
        public static List<ProductViewModel> productList
        {
            ...
            { if (_productList == null)
                {
                    _productList = GetProducts(20).ToList();
                }
                return _productList;
            }
        }
        ...
        {
            var selectedProduct = productList.Where(x => x.ProductId == id).FirstOrDefault();
            if (selectedProduct == null || id == Guid.Empty)
            {
        ...
        private static ProductViewModel GetProduct()
        {
            var product = new ProductViewModel()
            {
                ...
                ProductShortCode = "PHRM_" + GetRand(),
                ProductId = Guid.NewGuid(),
            };
            return product;
        }        
