...
{
    public class _HomeController : BaseController
    {
        public ActionResult Index()
        {
            ...
            newBatch._batchId = Encoding.UTF8.GetBytes("Batch14Dec2016Test01");
            ...
            //var result = Sync(GetBatchService().InitiateBatchTracking(newBatch));
